...
import org.insightedge.examples.financialengineering.{KafkaSettings, SpaceUsage, SparkUsage}
...
/**
  ...
  *
  */
object Feed extends SpaceUsage with SparkUsage {

  val sleepTimeMilliseconds: Long = 2000
  ...
  private def calculateNextFilename(tickerSymbol: TickerSymbol): String = {
    val basedir = AppSettings.feedDataDirectory
