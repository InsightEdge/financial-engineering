...
class SimpleRegressionModelSpec extends Spec{
  ...
  private val solidsReductionPercentage = List[Double](3, 7, 11, 15, 18, 27, 29, 30, 30, 31, 31, 32, 33, 33, 34, 36, 36)
  private val chemicalOxygenDemand = List[Double](5, 11, 21, 16, 16, 28, 27, 25, 35, 30, 40, 32, 34, 32, 34, 37, 38)
